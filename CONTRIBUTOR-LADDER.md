...
* **Responsibilities:**
    ...
    * Follow the reviewing guide for their sub-project, see the example from [Cilium](https://docs.cilium.io/en/stable/contributing/development/reviewers_committers/review_process/#review-process)
